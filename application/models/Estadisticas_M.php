...
class Estadisticas_M extends CI_Model {
	 ...
	 */
	function nro_total_trabajadores_por_direccion($id_trabajador = NULL, $ao = NULL){
...
/////////////////////////////////////////////////////////
// Funciones para obtener los datos por coordinaciones //
/////////////////////////////////////////////////////////
	...
	/**
	 * Funcion para obtener el numero de inasistencias por mes y año de una coordinacion
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $coordinacion_id [description]
	 * @param  array  $excluidos    [description]
	 * @return [type]               [description]
	 */
	function nro_registros_asistencia_por_mes_ano_coordinacion($mes = NULL,$ano = NULL,$coordinacion_id = NULL,$excluidos = array())
	{	
		if(is_null($mes) || is_null($ano) || is_null($coordinacion_id)) return NULL;
		$condicion = array();
		$condicion['b.out_coordinacion_id'] = $coordinacion_id;
	...
	/**
	 * Funcion para obtener el numero de registros de inasistencias por mes, ano y coordinacion
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $coordinacion_id [description]
	 * @param  array  $excluidos    [description]
	 * @return integer               [description]
	 */
	function nro_registros_inasistencia_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas requeridas por coordinacion a un mes y año especifico
	 ...
	 * @return [type]               [description]
	 */
	function nro_horas_requeridas_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL ,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
		...
		$query = $this->db->select("SUM(a.out_horas_requeridas) AS nro_horas")
						->from("asistencia.consulta_registros_asistencia_mes_ano('{$mes}','{$ano}') AS a")
						->where('a.out_coordinacion_id',$coordinacion_id)
						->group_by("a.out_coordinacion_id");
		if( count($excluidos) > 0 ) $query = $this->db->where_not_in("a.out_cargo_id",$excluidos);
		$query = $this->db->get()->result_array();
		if(count($query)>0) return $query[0]['nro_horas'];
		return "00:00:00";
	...
	/**
	 * Funcion para obtener el numero de horas requeridas por coordinacion en un mes y año especifico
	 * en formato UNIX
	 * @param  [type] $mes          [description]
	 * @param  [type] $ano          [description]
	 * @param  [type] $coordinacion_id [description]
	 ...
	 * @return [type]               [description]
	 */
	function int_horas_requeridas_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL ,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas trabajadas por coordinacion en un mes y año especifico
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $coordinacion_id [description]
	 * @param  array  $excluidos    [description]
	 * @return time               [description]
	 */
	function nro_horas_trabajadas_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas trabajas por mes y año de una coordinacion expresado en valor UNIX
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $coordinacion_id [description]
	 * @param  array  $excluidos    [description]
	 * @return integer               [description]
	 */
	function int_horas_trabajadas_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas faltantes por mes y año de una coordinacion
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $coordinacion_id [description]
	 * @param  array  $excluidos    [description]
	 * @return time               [description]
	 */
	function nro_horas_faltantes_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	...
	/**
	 * Funcion para obtener el numero dehoras faltantes  
	 * por mes y año de una coordinacion expresado en valor UNIX
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $coordinacion_id [description]
	 * @param  array  $excluidos    [description]
	 * @return integer               [description]
	 */
	function int_horas_faltantes_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	 ...
	 * @return time               [description]
	 */
	function nro_horasd_jornada_trabajadas_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	 ...
	 * @return integer               [description]
	 */
	function int_horasd_jornada_trabajadas_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	 ...
	 * @return time               [description]
	 */
	function nro_horasf_jornada_trabajadas_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	 ...
	 * @return integer               [description]
	 */
	function int_horasf_jornada_trabajadas_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	 ...
	 * @return time               [description]
	 */
	function nro_horas_jornada_faltantes_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	 ...
	 * @return integer               [description]
	 */
	function int_horas_jornada_faltantes_por_mes_ano_coordinacion_id($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	 ...
	 * @return time               [description]
	 */
	function nro_horas_horas_extras_por_mes_ano_coordinacion($mes = NULL,$ano = NULL, $coordinacion_id = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($coordinacion_id)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas extras realizadas
	 * por mes y año de un trabajador expresado en valor UNIX
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $id_trabajador [description]
	 * @param  array  $excluidos    [description]
	 * @return integer               [description]
	 */
	function int_horas_horas_extras_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;

		$query = $this->db->select("EXTRACT(EPOCH FROM SUM(a.out_horas_extras)) AS int_horas")
						->from("asistencia.consulta_registros_asistencia_mes_ano('{$mes}','{$ano}') AS a")
						->where('a.out_id_trabajador',$id_trabajador)
						->group_by("a.out_id_trabajador");
		if( count($excluidos) > 0 ) $query = $this->db->where_not_in("a.out_cargo_id",$excluidos);
		$query = $this->db->get()->result_array();
		if(count($query)>0) return $query[0]['int_horas'];
		return "0";
...
///////////////////////////////////////////////////////
// Funciones para obtener los datos por trabajadores //
///////////////////////////////////////////////////////

	/**
	 * Funcion para obtener el numero de inasistencias por mes y año de un trabajador
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $id_trabajador [description]
	 * @param  array  $excluidos    [description]
	 * @return [type]               [description]
	 */
	function nro_registros_asistencia_por_mes_ano_trabajador($mes = NULL,$ano = NULL,$id_trabajador = NULL,$excluidos = array())
	{	
		if(is_null($mes) || is_null($ano) || is_null($id_trabajador)) return NULL;
		$condicion = array();
		$condicion['b.out_id_trabajador'] = $id_trabajador;
	...
	/**
	 * Funcion para obtener el numero de registros de inasistencias por mes, ano y trabajador
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $id_trabajador [description]
	 * @param  array  $excluidos    [description]
	 * @return integer               [description]
	 */
	function nro_registros_inasistencia_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas requeridas por trabajador a un mes y año especifico
	 * @param  [type] $mes          [description]
	 * @param  [type] $ano          [description]
	 ...
	 * @return [type]               [description]
	 */
	function nro_horas_requeridas_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL ,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas requeridas por trabajador en un mes y año especifico
	 * en formato UNIX
	 * @param  [type] $mes          [description]
	 * @param  [type] $ano          [description]
	 * @param  [type] $id_trabajador [description]
	 ...
	 * @return [type]               [description]
	 */
	function int_horas_requeridas_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL ,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas trabajadas por trabajador en un mes y año especifico
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $id_trabajador [description]
	 * @param  array  $excluidos    [description]
	 * @return time               [description]
	 */
	function nro_horas_trabajadas_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas trabajas por mes y año de una trabajador expresado en valor UNIX
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $id_trabajador [description]
	 * @param  array  $excluidos    [description]
	 * @return integer               [description]
	 */
	function int_horas_trabajadas_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas faltantes por mes y año de un trabajador
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $id_trabajador [description]
	 * @param  array  $excluidos    [description]
	 * @return time               [description]
	 */
	function nro_horas_faltantes_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	 ...
	 * @return integer               [description]
	 */
	function int_horas_faltantes_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas trabajadas pertenecientes a la jornada laboral
	 * por mes y año de un trabajador
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $id_trabajador [description]
	 * @param  array  $excluidos    [description]
	 * @return time               [description]
	 */
	function nro_horasd_jornada_trabajadas_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	 ...
	 * @return integer               [description]
	 */
	function int_horasd_jornada_trabajadas_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	 ...
	 * @return time               [description]
	 */
	function nro_horasf_jornada_trabajadas_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	 ...
	 * @return integer               [description]
	 */
	function int_horasf_jornada_trabajadas_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	 ...
	 * @return time               [description]
	 */
	function nro_horas_jornada_faltantes_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	 ...
	 * @return integer               [description]
	 */
	function int_horas_jornada_faltantes_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
	...
	/**
	 * Funcion para obtener el numero de horas extras realizadas
	 * por mes y año de una trabajador
	 * @param  integer $mes          [description]
	 * @param  integer $ano          [description]
	 * @param  integer $id_trabajador [description]
	 * @param  array  $excluidos    [description]
	 * @return time               [description]
	 */
	function nro_horas_horas_extras_por_mes_ano_trabajador($mes = NULL,$ano = NULL, $id_trabajador = NULL,$excluidos = array())
	{
		if(is_null($mes) ||is_null($ano) ||is_null($id_trabajador)) return NULL;
