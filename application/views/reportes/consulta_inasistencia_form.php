    ...
    <div class="form-group ">
      ...
      <div class="col-md-10">
        <div class="input-group input-daterange">
            <input type="text" name="fdesde" id="fdesde" class="form-control" value="" readonly="readonly">
            <div class="input-group-addon">Hasta</div>
            <input type="text" name="fhasta" id="fhasta" class="form-control" value="" readonly="readonly">
        </div>
      </div>
    </div>
          <!-- Alerta -->
