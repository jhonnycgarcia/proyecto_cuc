...
<div class="row">
  <div class="col-md-12">
    <div class="box box-danger">
      <div class="box-header with-border">
        <h3 class="box-title">Informacion General por Trabajadores</h3>
      ...
      <div class="box-body">
        ...
        <table class="table table-hover table-bordered" id="tb_trabajadores">
          <thead>
            <tr>
              <th>#</th>
              ...
              <th class="text-center col-md-4">Apellidos y nombres</th>
              <th>Cargo</th>
