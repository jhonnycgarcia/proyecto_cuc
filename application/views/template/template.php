...
<head>
  ...
  <title>Master SIGEI Layout</title>
          ...
          <ul class="nav navbar-nav">
                  ...
                  <ul class="menu">
                    <li><!-- start message -->
                      <a href="#">
                        <div class="pull-left">
                          <!-- User Image -->
                          <img src="http://localhost/master_sigei1/assets/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                        </div>
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <img src="http://localhost/master_sigei1/assets/AdminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="http://localhost/master_sigei1/logout" class="btn btn-default btn-flat">Cerrar sesion</a>        <!-- <a href="#" class="btn btn-default btn-flat">Sign out</a> -->
                  </div>
                </li>
              </ul>
